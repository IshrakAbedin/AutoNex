...
## A template library collection in C++20 providing modern and flexible implementation of state-machine, event dispatcher, object pool, timer, concurrency containers, etc. for creating real-time engines
